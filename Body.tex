...
After these steps the installation and standard configuration will of strider will be complete. Per default strider uses the development mode to start in.
...
\newpage
\section{Automatic Testing With Strider}
\label{section:Automatic Testing With Strider}
