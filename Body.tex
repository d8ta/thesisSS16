...
\begin{figure}[h!]
  \centering
      \includegraphics[width=0.4\textwidth]{images/striderUI.png}
...
Since the goal ouf our pipline is to test and deploy after a successful commit striderCD needs to be connected to the used Version Controll
System. The example scenary uses Github as VCS. For this purpous the webapplicatoin needs to be pushed to a Github
