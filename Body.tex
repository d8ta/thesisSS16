...
to the research question is that the Issue reports and the experienced downtime together with the concluded build processes are supporting claim that
a striderCD system can be used as a stable CI service for NodeJS/MEAN applications.

% and the detailed work behind the well written and maintained documentations of MEANJS and striderCD.
