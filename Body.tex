...
with system wide environment variables for \textit{PORT}, \textit{SERVER_NAME}, \textit{HOST}, \textit{CONCURRENT_JOBS}, \textit{STRIDER_CLONE_DEST},
\textit{DB_URI} and \textit{HTTP_PROXY}.

These environmental variables can than startet with strider like calling them together with the start commnad. For example if the used \texit{PORT}
is 4000 and the \textit{SERVER_NAME} reads https://neolexon.com than the startup should look like this:
