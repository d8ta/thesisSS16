...
with system wide environment variables for \texit{PORT}, \texit{SERVER_NAME}, \texit{HOST}, \texit{CONCURRENT_JOBS}, \texit{STRIDER_CLONE_DEST},
\texit{DB_URI} and \texit{HTTP_PROXY}.
...
is 4000 and the \textig{SERVER_NAME} reads https://neolexon.com than the startup should look like this:
