...
got a huge amount of interest from local, national and international media (\url{http://www.bbc.com/news/world-us-canada-34383655} visited on 2. March 2016) and
...
This thesis will research \textit{how to build a CI and CD service for modern web applications with MEANJS}.
...
\begin{figure}[h!]
  ...
  \caption{continuous delivery cycle from \url{https://blog.risingstack.com/continuous-deployment-of-node-js-applications/} (visited on 17. April 2016)
\end{figure}
...
created a tutorial for this. It can be found under \url{https://www.digitalocean.com/community/tutorials/how-to-create-your-first-digitalocean-droplet-virtual-server} (visited on 2. April 2016).
...
% \footnote{https://futurestud.io/blog/strider-configure-and-use-webhooks} visited on 13. April 2016
...
source: \url{https://futurestud.io/blog/strider-configure-and-activate-email-notifications} visited on 5. April 2016
...
to the research question is that the Issue reports (\url{https://github.com/Strider-CD/strider/issues} visited on 27. April 2016) and the experienced downtime,
