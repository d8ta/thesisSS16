...
that will be effected by different changes that are made afterwards. It also leads to thought through programming decisions. Test-driven development focusses
on how TDD leads analysis, design, and programming decissions (\cite{janzen2005test}) which will be of help if the software application grows larger or more
complex.
