...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{images/email_activ.png}
...
\textbf{HOST}, \textbf{USER} and \textbf{PASS} are the main information. In this case the host is mailgun. The user and pass are your userdate
