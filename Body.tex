...
application is error free, the application can be build and deployed. Figure 5 shows how a continuous delivery process runs in general.

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{images/cd.png}
  \caption{continuous delivery cycle}
\end{figure}
...
are available to choose from. Furthermore i will show an idea of a usable workflow in operations and CI.
