...
for \testbf{M}odel - \testbf{V}iew - *. The * acutally is a placeholder and means you can use Angular in different ways. Be it MVC - Model View Controller
...
After this brief introduction of the different parts of the MEAN stack, this thesis will describe the tool that can be used for the MEAN stack and a
continuous delivery pipeline. Each tool will be described for why it is used in the example application. Since there are other tools than the below described
i will mentioned other configuration or possibilities to use. However this will be not a complete list. Appart from the MEAN software stack the neolexon
