...
Since this thesis treats the subject of CI/CD and not testing in general it will not describe testing in detail. Note that for the
...
now about the status of the deployment and the build? One of the good things about the different CI/CD services is that there is the
