...
For deployment THERE should use the very same process, whether it is for production or to a developer machine. By doing so you are be able to run all your builds
