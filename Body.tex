...
\section{Continuous Integration and Automatization in Development Operations}
...
I will start to describe the differences between continous integration, -delivery and -deployment and what is needed to build a stable CI pipline. I also
will explain what parts are essential for a CI pipline and what options are available to choose from. Furthermore i will show an idea of a usable workflow
in operations and CI.

during development code needs to be shiped and tested. Development operations will provide the needed operations and background to test and ship the code
from a local setup to any kind of server. For this development operations rely on automatication in the process to make sure that new features are build,
tested an integrated into a running system. (figure 4)
